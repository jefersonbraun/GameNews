...
class GK_NSP_Widget extends WP_Widget {
	...
	?>	
		...
		<div class="gk-nsp-col">
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'article_readmore_state' ) ); ?>"><?php _e('Leia', GKTPLNAME); ?></label>
	 ...
	 **/
	 ...
	 function generate_art_readmore($i) {
	 	...
	 	$output = '<a href="'.$art_url.'" class="readon btn" title="'.__('Leia', GKTPLNAME).'">'.__('Leia', GKTPLNAME).'</a>';
